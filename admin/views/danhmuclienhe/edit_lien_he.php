 ...
 <div class="card">
                                ...
                                <div class="card-body">               
                                    <div class="live-preview">
                                        ...
                                        <form action="?act=post-sua-lien-he" method="POST">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="trang_thai" class="form-select">
                                                            <option value="1" <?= $lienHe['trang_thai'] == 1 ? 'selected' : ''?>>Đã liên Hệ</option>
                                                            <option value="2" <?= $lienHe['trang_thai'] == 2 ? 'selected' : ''?>>Chưa liên hệ</option>
                                                        </select>
