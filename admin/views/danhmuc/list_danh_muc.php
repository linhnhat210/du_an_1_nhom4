        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="?act=search-danh-muc" method="POST">
                                <div class="row">
                                    <div class="col-md-3">
                               ...
                               <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Danh Mục Sản Phẩm</h4>
                                     <a href="?act=form-them-danh-muc" type="button" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i>Thêm Danh Mục</a>
