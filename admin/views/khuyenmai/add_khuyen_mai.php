 ...
 <div class="card">
                                ...
                                <div class="card-body">               
                                    <div class="live-preview">
                                        <form action="?act=post-them-khuyen-mai" method="POST" enctype="multipart/form-data"> 
                                            
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="citynameInput" class="form-label">Mã Khuyến Mãi</label>
                                                        <input type="text" class="form-control" placeholder="Nhập vào mã khuyến mãi(*)" name="ma_khuyen_mai">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập vào giá trị của mã(*)" name="giam_phan_tram">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập vào số tiền tối đa được giảm(*)" name="giam_toi_da">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhập vào ngày bắt đầu" name="ngay_bat_dau">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhập vào sô lượng(*)" name="ngay_ket_thuc">
